...
const { currentLocation, currentLoationStatus } = storeToRefs(locationStore);
...
effect(() => {
    if (LOCATION_PAGES.has(route.name?.toString() || "")) {
        ...
        if (currentLocation.value && currentLoationStatus.value !== "pending") {
    ...
    <div class="flex-1 flex">
        ...
        >
            ...
            <div class="flex flex-col">
                ...
                />
                <div
                    v-if="route.path.startsWith('/dashboard/location') && currentLoationStatus === 'pending'"
